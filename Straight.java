/* 
   Mark Porter
   Program: Poker Game Part Straight
   Assignment: DETERMINE WHETHER IT'S A Straight
   November 5, 2015
*/
...
{//opening of class Straight


 public int displayStraight(int card1, int card2, int card3, int card4, int card5, int winner)
	...
	if ((card1num  + 1 == card2num) & (card1num + 2 == card3num ) & (card1num + 3 == card4num ) & (card1num + 4 == card5num))
	{

	System.out.printf("\n   It is a %s HIGH Straight\n", card5name) ;
	winner =  card5num ;
	}
	else if ((card2num == card1num  + 9 ) & (card3num == card1num + 10) & ( card4num == card1num + 11 ) & ( card5num == card1num + 12))
	{
	System.out.printf("\n   It is a %s HIGH Straight\n", card1name) ;
	winner =  14 ;
	}
